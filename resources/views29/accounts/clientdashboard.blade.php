    ...
    <body onLoad="javascript:init()">
        ...
        <div class="nav nav2" style="padding-left: 30px; padding-top: 20px">
            <ul>
                ...
                <li style="padding-top: 5px;"> <a href="javascript:showsubscriptions()"> Subsciptions</a> </li>
					...
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
						...
						<div class="loadly_myaccount_4">
								...
								<div style="display: inline-block; margin-right: 20px;"> 
									...
									<div class="loadly_myaccount_profile">
										<input id="lastname" class="cinput" style="padding-left: 20px;border-color: grey;" name="lastname" type="text" required="required" placeholder="Last name" value="{{ $data['lname']}}" />
									<label for="lastname" class="floating__label" data-content="Last name"> 
									</div>

									<div class="loadly_myaccount_profile">
										<input id="email" class="cinput" style="padding-left: 20px;border-color: grey;" name="email" type="email" required="required" placeholder="Email" name="email" value="{{ $data['email'] }}" />
									<label for="email" class="floating__label" data-content="Email">
									</div>
									<div class="loadly_myaccount_profile">
										<input id="phone" class="cinput" style="padding-left: 20px;border-color: grey;" name="phone" type="phone" required="required" placeholder="phone" value="{{ $data['phone']}}"/>
								 ...
								 <div style="display: inline-block">
											...
											<div style="display: block; padding-top: 7px;">
											   ...
											   <div style="display: block; padding-top: 7px;">
												<input id="apt" class="cinput" style="padding-left: 20px;border-color: grey;" name="apt" type="apt" placeholder="Apt/suite(optional)" value="{{ $data['apt']}}" />
												<label for="apt" class="floating__label" data-content="Apt/suite(optional"> 
											   </div>

											   <div>
												   <div style=" padding-top: 7px;">
													<input id="zipcode" class="cinput" style="padding-left: 20px; border-color: grey;"name="zipcode" type="zipcode" required="required" placeholder="zipcode" value="{{ $data['zipcode']}}" />
												<label for="zipcode" class="floating__label" data-content="zipcode"> 

												</div>
												   <div style="padding-top: 7px;"> 
													<input id="city" class="cinput" style="padding-left: 20px;border-color: grey;" name="city" type="city" placeholder="city" value="{{ $data['phone']}}" />
...
<form id="frm_submitpayments" >
		...
		<div class="alert_payment alert-success" style="display:none"></div>
...
<form  id="frm_cleaningpreferences" >
					...
					@if($message = Session::get('cleaningpref_error')) 
					   ...
					   @endif
<div class="alert_cleanigpref alert-success" style="display:none"></div>
...
<div class="alert_deliverypref alert-success" style="display:none"></div>
<input type="hidden" name="_token" value="{{ csrf_token() }}">
		...
		<div style="display:block; padding-top:10px;">
			...
			<div class="loadly_rinsedrop2">
                 ...
                 <div style="padding-top: 7px;">
                    <input type="checkbox" id="rushservice_washfold" name="rushservice_washfold" value="washfold" style="vertical-align: top;">
                 ...
                 <div style="padding-top: 7px;">
                 <input type="checkbox" id="rushservice_drycleaning" name="rushservice_drycleaning" value="none" style="vertical-align: top;">
		...
		<div style="display: block; padding-top:30px;">
			<div class="loadly_rinsedrop1">
				 ...
				 <div style="padding-top: 5px;" >
                        <textarea name="delivery_instructions" id="delivery_instructions" cols="30" rows="8" class="loadly_contents_fonts"> Delivery instruction (optional)</textarea>
                 </div>
...
<!--User subscriptions -->
        ...
        <div id="div_subscriptions" style="display: inline-block; width: 79%; height: 100%; vertical-align:top;">
		   <div style="margin-top: 20px; margin-left:40px;">

		   <input type="hidden" name="_token" value="{{ csrf_token() }}">

		   <div class="alert_usersub alert-success" style="display:none"></div>
			...
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
			<div class="loadly_titles_sub2"> Unsubscribe</div> <div class="alert_remsub alert-success" style="display:none"></div>
			<div style="margin-top: 20px;">
			  <span >
