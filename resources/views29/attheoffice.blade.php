...
<div style="width:93%;  height:600px; vertical-align:top; padding: 0 0 0 5%;">
				 ...
				 <div style="background-color:orange;cursor:pointer;favorite styled;color:white;padding:10px;text-align:center; font-size:20px">Learn more</div>
...
<div style="display:inline-block; width:100%; margin-left:5px; margin-right:5px; background:#fff; height:auto; vertical-align:top"> 
        ...
        <div class="loadly_ao_bayarea">
				...
				<div style="background-color:orange;cursor:pointer;favorite styled;color:white;padding:10px;text-align:center;">Get started</div>
				</span>		 
