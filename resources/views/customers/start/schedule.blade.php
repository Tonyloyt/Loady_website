...
<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>"><br>   
   <div id="div_schedulepickup" class="loadly_schedule_main"> 
	 ...
	 @if($message=="Insert successfully"))
		<script>window.location="../../accounts/clientdashboard?page=orders";</script>
	   @endif
         ...
         jQuery(document).ready(function(){
            ...
            jQuery('#submitcontinue').click(function(e){
               ...
               $.ajaxSetup({
				...
				var rs="";
				  if(jQuery('#chk_drycleaning').is(':checked')){
					rs="Dry Cleaning.";
				  }
				  var rd="";
				  if(jQuery('#chk_washfold').is(':checked')){
					rd="Wash & fold";
				  }
				  var dd="";
				  if(jQuery('#chk_hangdry').is(':checked')){
					dd="Hang Dry";
				  }
			  ...
			  jQuery.ajax({
                  ...
                  data: {
					 ...
					 scheduleddate: jQuery('#input__scheduleddate').val(),
					 drycleaning: rs,
					 washfold: rd,
					 hangdry: dd,
                  ...
                  success: function(result){
					  ...
					  if(result.success=="ok"){
						window.location.href = "../../accounts/clientdashboard";
						 ...
						 jQuery('.alert_account').html("pls wait while redirecting");
						 jQuery('.alert_account').css("color", "red");
					  }else{
						 jQuery('.alert_account').show();
